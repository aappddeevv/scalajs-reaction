...
object Button {
  ...
  trait IButton extends Focusable {
    ...
    def openMenu(shouldFocusOnContainer: js.UndefOr[Boolean],
      shouldFocusOnMount: js.UndefOr[Boolean]): Unit
  }
  ...
  trait Props
    ...
    var getClassNames: js.UndefOr[js.Function9[
      ...
      Unit]] = js.undefined
    var getSplitButtonClassNames: js.UndefOr[js.Function3[
      Boolean, Boolean, Boolean, ISplitButtonClassNames]] = js.undefined
